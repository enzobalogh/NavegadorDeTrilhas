...
## Atualização: Registrar Trilha com GPS sem Google Cloud

A tela **Registrar Trilha** foi adaptada para usar **OpenStreetMap/OSMDroid** em vez de Google Maps.

Com isso, o projeto não precisa de:
...
A tela registra a localização do usuário pelo GPS/serviço de localização do Android e mostra:
...
- distância total;
- linha do percurso;
- salvamento da trilha e dos pontos no SQLite.

Para testar, abra o projeto no Android Studio, rode em um celular ou emulador, permita a localização e clique em **Registrar Trilha > Iniciar trilha**.
